      ...
      <section className="workspace" id="evaluation-console">
        ...
        <div className="panel panel--scenario">
          ...
          {isCustom ? <div className="sandbox-grid">
            ...
            <div className="sandbox-draft-note"><span>{isGeneratingResponse ? "Generating" : "Demo simulation"}</span><p>Auto-generated for demo purposes. This sandbox simulates customer-support AI; unrelated prompts receive a clear guide instead of a random policy answer.</p></div>
