      ...
      <section className="workspace" id="evaluation-console">
        ...
        <div className="panel panel--scenario">
          ...
          {isCustom ? <div className="sandbox-grid">
            ...
            <div className="sandbox-draft-note"><span>{isGeneratingResponse ? "Generating" : generationSource === "live" ? "Live (Gemini 2.5 Flash-Lite)" : "Simulated (demo mode)"}</span><p>{generationSource === "live" ? "Live output is held for ControlPlane’s policy checks before any release decision." : "Local demo output is ready immediately and follows the same policy-check flow."}</p></div>
