      ...
      <section className="workspace" id="evaluation-console">
        ...
        <div className="panel panel--scenario">
          ...
          {isCustom ? <div className="sandbox-grid">
            ...
            <div className="sandbox-draft-note"><span>{isGeneratingResponse ? "Generating" : "Demo simulation"}</span><p>Auto-generated for demo purposes. PII examples intentionally contain fictional unsafe data so the checker can catch it.</p></div>
